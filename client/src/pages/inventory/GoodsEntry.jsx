...
const GoodsEntry = () => {
    ...
    const GoodsFields = [
        ...
        { label: "Ordered Date", name: "Ordered Date", type: "date", category: "Goods Entry" },
        ...
        { label: "Reason/Purpose", name: "Reason / Purpose", type: "text", category: "Goods Entry" },
        // { label: "Added By", name: "Added By", type: "text", category: "Goods Entry" },
        { label: "Last Edited by", name: "Last Edited by", type: "text", category: "Goods Entry" },
        { label: "Last Edited Date", name: "Last Edited Date", type: "date", category: "Goods Entry" },

        /* Add Goods */
        // { label: "Product ID", name: "productID", type: "number", category: "Add Goods" },
        { label: "Date of Manufacturing", name: "dateOfManufacturing", type: "date", category: "Add Goods" },
        ...
        { label: "Batch Number", name: "batchNumber", type: "number", category: "Add Goods" },
        { label: "Storage Location", name: "storageLocation", type: "text", category: "Add Goods" },
        { label: "Additional Note", name: "additionalNote", type: "number", category: "Add Goods" }
    ];
